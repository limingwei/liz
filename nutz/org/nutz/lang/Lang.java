...
public abstract class Lang {
	 ...
	 * @return Map 对象
	 */
	public static <T extends Map<Object, Object>> Map<?, ?> collection2map(Class<T> mapClass, Collection<?> coll, String keyFieldName) {
		if (null == coll)
			return null;
	 ...
	 * @return Map 对象
	 */
	public static <T extends Map<Object, Object>> Map<?, ?> array2map(Class<T> mapClass, Object array, String keyFieldName) {
		if (null == array)
			return null;
		Map<Object, Object> map = createMap(mapClass);
	 ...
	 * 
	 * @param obj 对象
	 * @param loopMap 是否循环 Map，如果循环 Map 则主要看 callback 的 T，如果是 Map.Entry 则循环 Entry 否循环 value。如果本值为 false， 则将 Map 当作一个完整的对象来看待
	 * @param callback 回调
	 */
	...
	private static <T extends Map<String, Object>> void obj2map(Object obj, T map, Map<Object, Object> memo) {
		...
		for (Field fld : flds) {
			...
			if (mr.isNumber() || mr.isBoolean() || mr.isChar() || mr.isStringLike() || mr.isEnum() || mr.isDateTimeLike()) {
