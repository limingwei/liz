...
public abstract class Maths {
	 ...
	 * 
	 * @param bs integer, bit map
	 * @param mask another bit map
	 * @return if one of bit value is '1' in mask, and it is also is '1' in bs return true, else false
	 */
	 ...
	 * @param bs integer, bit map
	 * @param mask another bit map
	 * @return if all bit value is '1' in mask, and it is also is '1' in bs return true, else false
	 */
	 ...
	 * 
	 * @param bs original integer
	 * @param low the low bit position (inclusive), 0 base
	 * @param high the hight bit position (exclusive), 0 base
	 * @return new integer
	 */
