...
public class InjectByField implements Injecting {
	...
	public void inject(Object obj, Object value) {
		...
		try {
			...
			throw Lang.makeThrow("Fail to set '%s'[ %s ] to field %s.'%s' because [%s]: %s", value, v, field.getDeclaringClass().getName(), field.getName(), Lang.unwrapThrow(e), Lang.unwrapThrow(e).getMessage());
		}
	}
}
