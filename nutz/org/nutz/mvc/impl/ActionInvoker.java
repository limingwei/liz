...
public class ActionInvoker {
	 ...
	 * 增加 ActionChain
	 * 
	 * @param httpMethod HTTP 的请求方法 (GET|POST|PUT|DELETE),如果为空，则会抛错
	 * @param chain 动作链
	 */
	...
	public String toString() {
		return String.format("%s&%s", defaultChain == null ? "----" : "DEFT", Json.toJson(chainMap.keySet(), JsonFormat.compact()));
	}
