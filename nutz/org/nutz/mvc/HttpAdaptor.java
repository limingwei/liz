 ...
 * <b>注意：</b>
 * <ul>
 * <li>如果你要写自己的实现类，这个类必须有一个public 的默认构造函数，如果你的构造函数需要参数，则必须是 String 类型的。参数的值由 注解 '@AdaptBy.args' 来填充，它的默认值为 长度为0的空字符串数组。
...
public interface HttpAdaptor {
	 ...
	 * @param req 请求对象
	 * @param resp 响应对象
	 * @param pathArgs 字符串数组，路径参数。详情请参看 <a href="http://code.google.com/p/nutz/wiki/mvc_http_adaptor#路径参数" >路径参数</a>
	 * 
	 * @return 调用参数数组
	 * 
	 */
	Object[] adapt(ServletContext sc, HttpServletRequest req, HttpServletResponse resp, String[] pathArgs);
