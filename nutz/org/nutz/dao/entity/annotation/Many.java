 ...
 * <ul>
 * <li><b>target</b>: 你的这个字段对应的实体类。通常，这个类得是你的字段的一个子类或者实现类。或者它能够顺利的通过 Nutz.castor 转换成 你的字段
 ...
 * <p>
 * <blockquote> 本注解是一个略微让人疑惑的名称，你可能会想，你声明 '@Many' 的字段必须是一个容器或者数组，其实，它也可以 是一个单个对象。
 * <p>
