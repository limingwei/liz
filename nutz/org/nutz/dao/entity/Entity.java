...
public interface Entity<T> {
	 ...
	 * 
	 * @param rs 结果集
	 * @param matcher 字段匹配器。如果为null，则获取实体的全部字段
	 * @return Java 对象
	 */
	 ...
	 * @param obj 映射的宿主对象
	 * @param visitor 处理器
	 * @param regex 正则表达式匹配 Java 字段名。null 表示匹配所有一对一映射字段
	 * @return 匹配上的映射字段
	 */
	 ...
	 * @param obj 映射的宿主对象
	 * @param visitor 处理器
	 * @param regex 正则表达式匹配 Java 字段名。null 表示匹配所有一对多映射字段
	 * @return 匹配上的映射字段
	 */
	 ...
	 * @param obj 映射的宿主对象
	 * @param visitor 处理器
	 * @param regex 正则表达式匹配 Java 字段名。null 表示匹配所有多对多映射字段
	 * @return 匹配上的映射字段
	 */
