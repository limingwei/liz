...
public abstract class Pojos {
	...
	public static class Items {
		...
		public static PItem cndAuto(Entity<?> en, Object obj) {
			...
			default:
				...
				throw Lang.makeThrow("Don't know how to make fetch key %s:'%s'", en.getType().getName(), obj);
			}
		}
	...
	private static final Pattern ptn = Pattern.compile("^(WHERE|ORDER BY)(.+)", Pattern.CASE_INSENSITIVE);
